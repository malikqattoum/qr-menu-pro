        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-10 text-center">
                    <h2>{{ ___('Watch How It Works!') }}</h2>
                    <p>{{ ___('Check out this quick video to see how you can create a digital menu in minutes!') }}</p>
                    <div class="">
                        <iframe width="100%" height="450" src="https://www.youtube.com/embed/oTQNOYD4J_Y" 
                                title="QR Menu Demo" frameborder="0" allowfullscreen>
                        </iframe>
                    </div>
                </div>
            </div>
